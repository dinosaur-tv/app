...
Экран поддерживает самостоятельные интерьерные, природные и городские сцены: `gallery`, `home-day`, `home-evening`, `night`, `play`, `forest`, `mountains`, `sea`, `space`, `petersburg`, `rome`, `florence` и `venice`. У каждой своя композиция, типографика и фоновое движение; весь интерфейс дополнительно сдвигается на несколько пикселей каждые 90 секунд для защиты телевизора от статичного изображения.
