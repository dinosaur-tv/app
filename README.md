...
Экран поддерживает семь самостоятельных сцен: `gallery`, `night`, `play`, `forest`, `mountains`, `sea` и `space`. У каждой своя композиция, типографика и фоновое движение; весь интерфейс дополнительно сдвигается на несколько пикселей каждые 90 секунд для защиты телевизора от статичного изображения.
